...
//3DES算法
int TripleDES_Encrypt(ElemType* plainBuffer, ElemType* keyBuffer, ElemType* cipherBuffer, int n);//加密数据 
int TripleDES_Decrypt(ElemType* cipherBuffer, ElemType* keyBuffer, ElemType* plainBuffer, int n);//解密数据 
int TripleDES_Encrypt_File(char* plainFile, char* keyStr, char* cipherFile);//加密文件  
int TripleDES_Decrypt_File(char* cipherFile, char* keyStr, char* plainFile);//解密文件 
